...
public class WhiteSpaceTruncatingTest {

	/**
	 * Comparison of IdentifierRenaming1.py and WhiteSpaceCheck.py.
	 * @throws IOException
	 */
	@Test
	public void test_CompareStrategyAll() throws IOException, URISyntaxException {
	    ...
	    File file2=new File("src/main/java/com/northeastern/msd/team102/plagiarismchecker/samplepython/sprint3Test/WhiteSpaceCheck.py");
	...
	public void test_CompareStrategyAll2() throws IOException, URISyntaxException {
		CompareStrategy c = new CompareStrategyAll();
	    File file1=new File("src/main/java/com/northeastern/msd/team102/plagiarismchecker/samplepython/sprint3Test/WhiteSpaceCheck.py");
		byte[] encodedFile1 = Files.readAllBytes(file1.toPath());
